...
public class WindowsUtils {
  ...
  public static final String BASE_APPLICATION_CSS_PATH = WindowsUtils.class.getResource("/css/application.css").toExternalForm();
  public static final String ICON_APP_PATH = WindowsUtils.class.getResource("/images/icon.png").toExternalForm();
  ...
  public static FXMLLoader loadFxml(String url) {
    ...
    try (InputStream fxmlStream = WindowsUtils.class.getResourceAsStream(url)) {
      ...
      loader.setControllerFactory(BeanUtils::getBean);
      loader.setResources(BeanUtils.getBean(I18N.class).getBundle());
